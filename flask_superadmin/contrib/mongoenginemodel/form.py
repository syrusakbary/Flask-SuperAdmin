...
from fields import ModelSelectField, ModelSelectMultipleField, ListField, TagListField
...
class AdminModelConverter(object):
    ...
    def convert(self, model, field, field_args,multiple=False):
        ...
        if field.choices:
            ...
            if not multiple:
                ...
                return f.SelectMultipleField(widget=form.ChosenSelectWidget(multiple=multiple),**kwargs)
    ...
    def conv_List(self, model, field, kwargs):
        ...
        if isinstance(field.field,ReferenceField): return ModelSelectMultipleField(widget=form.ChosenSelectWidget(multiple=True),model=field.field.document_type,**kwargs)
    ...
    def conv_Reference(self, model, field, kwargs):
        return ModelSelectField(widget=form.ChosenSelectWidget(),model=field.document_type, **kwargs)
...
def model_fields(model, only=None, exclude=None, field_args=None, converter=None):
    ...
    converter = converter or AdminModelConverter()
