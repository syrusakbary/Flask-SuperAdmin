...
Steps to add new model backend:
    ...
    1. Create new class and derive it from :class:`~flask.ext.superadmin.model.BaseModelView`::
    ...
    - :meth:`~flask.ext.superadmin.model.BaseModelView.get_pk_value`

    This method will return primary key value from
    the model. For example, in SQLAlchemy backend,
    it gets primary key from the model using :meth:`~flask.ext.superadmin.contrib.sqlamodel.ModelView.scaffold_pk`, caches it
    ...
    - :meth:`~flask.ext.superadmin.model.BaseModelView.scaffold_list_columns`
    ...
    - :meth:`~flask.ext.superadmin.model.BaseModelView.scaffold_sortable_columns`
    ...
    - :meth:`~flask.ext.superadmin.model.BaseModelView.init_search`
    ...
    - :meth:`~flask.ext.superadmin.model.BaseModelView.is_valid_filter`
    ...
    Filter is a class derived from :class:`~flask.ext.superadmin.model.filters.BaseFilter` which implements at least two methods:

        1. :meth:`~flask.ext.superadmin.model.filters.BaseFilter.apply`
        2. :meth:`~flask.ext.superadmin.model.filters.BaseFilter.operation`
    ...
    All SQLAlchemy filters derive from :class:`~flask.ext.superadmin.contrib.sqlamodel.filters.BaseSQLAFilter` class.
    ...
    - :meth:`~flask.ext.superadmin.model.BaseModelView.scaffold_filters`
    ...
    - :meth:`~flask.ext.superadmin.model.BaseModelView.scaffold_form`
        ...
        - :meth:`~flask.ext.superadmin.model.BaseModelView.get_list`
        ...
        - :meth:`~flask.ext.superadmin.model.BaseModelView.get_one`

        Return one model by its primary key.

        - :meth:`~flask.ext.superadmin.model.BaseModelView.create_model`

        Create new model from the `Form` object.

        - :meth:`~flask.ext.superadmin.model.BaseModelView.update_model`

        Update provided model with the data from the form.

        - :meth:`~flask.ext.superadmin.model.BaseModelView.delete_model`
