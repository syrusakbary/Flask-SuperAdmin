...
setup(
    ...
    description="The best admin interface framework for Python. With scaffolding for MongoEngine and SQLAlchemy.",
    ...
    tests_require=["nose>=1.0", "Flask", "flask-sqlalchemy", "mongoengine"],
    classifiers=[
